    ...
    return (
      <div className="navbar-default navbar-side">
        <div className="sidebar-collapse">
          <ul className="nav">
            <li>
              <NavLink exact to="/" activeClassName="active-menu"><i className="fa fa-dashboard"></i>首页</NavLink>
            </li>
            <li className="active">
              <Link to="/product">
              ...
              <ul className="nav nav-second-level collapse in">
                <li>
                  <NavLink exact activeClassName="active-menu" to="/product">商品管理</NavLink>
                </li>
                <li>
